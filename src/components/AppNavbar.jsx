  ...
  return (
    <div className="relative border-t lg:border-none">
      ...
      >
        ...
        <button
        onClick={onLogOut}
        className="block w-full text-justify text-red-500 hover:text-red-900 border-t py-3 lg:hover:bg-gray-50 lg:p-3">
          Logout
        </button>
      </ul>
    </div>
...
export default function AppNavbar() {
  ...
  const navigation = [
    ...
    { title: "Upcomming", path: "/up-comming" },
    { title: "NowPlaying", path: "/now-Playing" },
    { title: "TopRate", path: "/Top-rate" },
    ...
    <header className="text-base lg:text-sm">
      ...
      >
        <div className="flex items-center justify-between py-3 lg:py-5 lg:block">
          <Link to="/">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS8Wx6Z0kZX5LDnk_RtFBnGeG1JSkNJ8pWFzQ&s"
              width={200}
              height={100}
              alt="Float UI logo"
            />
